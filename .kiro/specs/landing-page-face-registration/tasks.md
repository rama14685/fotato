...
- [x] 1.1 Create migration for `user_face_embeddings` table
  - [x] 1.1.1 Add columns: id, user_id, embedding_vector (TEXT), timestamps
  - [x] 1.1.2 Add foreign key constraint on user_id (cascade delete)
  - [x] 1.1.3 Add index on user_id
- [x] 1.2 Create `UserFaceEmbedding` model
  - [x] 1.2.1 Define fillable fields
  - [x] 1.2.2 Add relationship to User model (belongsTo)
  - [x] 1.2.3 Add accessor for decrypting embedding_vector
  - [x] 1.2.4 Add mutator for encrypting embedding_vector

### 2. Update Users Table
- [ ] 2.1 Create migration to add `face_embedding_id` to users table
  - [x] 2.1.1 Add nullable integer column `face_embedding_id`
  - [x] 2.1.2 Add foreign key constraint to user_face_embeddings.id
